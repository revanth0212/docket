...
Cortex answers natural language questions by retrieving relevant memories
...
Cortex only returns memories whose `validFrom`/`validTo` window includes that date.
