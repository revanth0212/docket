...
description: Full reference for docket.yaml configuration options.
---

# Config Schema Reference

Want an interactive version of this reference? Try the [Config Builder](/docs/users/config-builder).
