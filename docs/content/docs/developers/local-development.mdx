...
description: Set up your development environment and contribute to Cortex.
---

# Local Development

This guide covers how to set up a local development environment for hacking on Cortex core or building adapters.
