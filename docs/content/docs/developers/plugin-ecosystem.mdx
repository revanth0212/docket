...
| `cortexCompatibility` | string | yes | Semver range of supported Docket versions |
...
5. **Pin `cortexCompatibility`** — Be honest about which Docket versions you support.
6. **Use semantic versioning** — Breaking changes = major version bump.

## Coming soon

- **Plugin marketplace** — Curated list of community adapters
- **CLI onboarding** — `docket plugin install groq` instead of `npm install`
