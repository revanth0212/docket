---
title: Onboarding
description: Deploy Cortex on Cloudflare from scratch.
---
...
cortex:
  adapters:
    llm:
      ...
      providers:
        cloudflare-workers-ai:
          adapter: "@cortex/llm-cloudflare-workers-ai"
          config:
    ...
    embedder:
      ...
      providers:
        cloudflare-workers-ai:
          adapter: "@cortex/embedder-cloudflare-workers-ai"
          config:
            accountId: "${CF_ACCOUNT_ID}"
            apiToken: "${CF_API_TOKEN}"
    ...
    store:
      ...
      providers:
        cloudflare-d1:
          adapter: "@cortex/store-cloudflare-d1"
          config:
            accountId: "${CF_ACCOUNT_ID}"
    ...
    queue:
      ...
      providers:
        cloudflare-queues:
          adapter: "@cortex/queue-cloudflare"
          config:
            accountId: "${CF_ACCOUNT_ID}"
